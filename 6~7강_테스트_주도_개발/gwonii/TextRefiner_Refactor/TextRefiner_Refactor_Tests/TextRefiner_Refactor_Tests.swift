//
//  TextRefiner_Refactor_Tests.swift
//  TextRefiner_Refactor_Tests
//
...
class TextRefiner_Refactor_Tests: XCTestCase {

    let sut: TextRefiner_Refactor = TextRefiner_Refactor()
